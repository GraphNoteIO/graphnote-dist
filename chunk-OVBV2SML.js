...
`,Ao=[[["","matChipEdit",""]],[["mat-chip-avatar"],["","matChipAvatar",""]],[["","matChipEditInput",""]],"*",[["mat-chip-trailing-icon"],["","matChipRemove",""],["","matChipTrailingIcon",""]]],To=["[matChipEdit]","mat-chip-avatar, [matChipAvatar]","[matChipEditInput]","*","mat-chip-trailing-icon,[matChipRemove],[matChipTrailingIcon]"];function Oo(n,r){n&1&&E(0,"span",0)}function Fo(n,r){n&1&&(l(0,"span",1),B(1),c())}function Po(n,r){n&1&&(l(0,"span",3),B(1,1),c())}function Ro(n,r){n&1&&B(0,2)}function Vo(n,r){n&1&&E(0,"span",7)}function Lo(n,r){if(n&1&&f(0,Ro,1,0)(1,Vo,1,0,"span",7),n&2){let e=h();v(e.contentEditInput?0:1)}}function No(n,r){n&1&&B(0,3)}function Bo(n,r){n&1&&(l(0,"span",6),B(1,4),c())}var or=["*"],zo=`.mat-mdc-chip-set {
  display: flex;
}
