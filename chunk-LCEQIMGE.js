...
`],encapsulation:2,changeDetection:0})}return t})(),Vr=(()=>{class t{static \u0275fac=function(n){return new(n||t)};static \u0275mod=k({type:t});static \u0275inj=C({imports:[Y]})}return t})();var Gr=(()=>{class t{static \u0275fac=function(n){return new(n||t)};static \u0275mod=k({type:t});static \u0275inj=C({imports:[Y]})}return t})();var Xa=["*"],qa=`.mdc-list {
  margin: 0;
  padding: 8px 0;
